...
function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      <ToastContainer />
      <header
        className="relative h-60 flex items-center justify-center bg-cover bg-center"
      ...
      <div className="container mx-auto px-6 mt-8">
          ...
          <div className="bg-gray-800 p-6 rounded-lg shadow-lg flex items-center justify-between">
            <div>
              ...
              <button
                ...
                className="mt-3 bg-yellow-500 hover:bg-yellow-600 text-white px-4 py-2 rounded transition"
              >
                View Donors
              </button>
            </div>
        ...
        <div className="flex justify-center mt-10">
          <button
            ...
            className="bg-red-600 hover:bg-red-700 text-white px-6 py-3 rounded-lg flex items-center gap-2 shadow-lg transition"
          >
